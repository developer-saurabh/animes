...
class _AnimeDetailPageState extends State<AnimeDetailPage> {
  ...
  static const String _fallbackTrailerUrl =
  ...
  const String url = 'https://www.youtube.com/watch?v=LV-nazLVmgo'; /// for now I have passes harcoded url it can be replaced with api url 
  ...
  Widget _synopsisText(String? synopsis) => Padding(
        padding:
  ...
  Widget _genresRow(AnimeModel anime) => Padding(
        padding:
            const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
        child: Wrap(
          spacing: 8,
  ...
  Widget _shimmerView() => Shimmer.fromColors(
